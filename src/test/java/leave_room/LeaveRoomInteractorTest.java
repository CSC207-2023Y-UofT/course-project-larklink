...
public class LeaveRoomInteractorTest {
    ...
    public void testLeaveRoomSuccessfully() {
        // Simulate getting a room and logging in a user
        Room.setRoom(roomID, "Test Room", userID2, new ArrayList<>(Arrays.asList(userID, userID2)), "");
        User.setUser(userID, "", "");
    ...
    public void testLeaveRoomFailed() {
        // Simulate getting a room and logging in a user
        Room.setRoom(roomID, "Test Room", userID2, new ArrayList<>(List.of(userID2)), "");
        User.setUser(userID, "", "");
